        ...
        {plans.map((plan) => {
          ...
          return (
            <div key={plan.id} className={`relative h-full ${isRecommended ? 'plan-card-recommended' : ''}`}>
              ...
              >
                {isRecommended && (
                  // Máscara opaca própria: o fundo "selecionado" (bg-primary/5) é
                  // translúcido de propósito, e sem isso o anel giratório do
                  // wrapper vazava por trás dele quando o plano era selecionado.
